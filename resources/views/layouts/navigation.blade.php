        ...
        <div class="flex justify-between h-16">
            <div class="flex">
               ...
               <!-- @if(Auth::user()->hasRole('mahasiswa'))
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.buatsurat')" :active="request()->routeIs('dashboard.buatsurat')">
                        {{ __('Buat Surat') }}
                    </x-nav-link>
                </div>
                @endif -->
                ...
                @if(Auth::user()->hasRole('mahasiswa'))
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.suratkeluar')" :active="request()->routeIs('dashboard.suratkeluar')">
                        {{ __('Surat Keluar') }}
                    </x-nav-link>
                </div>
                @endif
